...
The statistics lab will be made available by
<AssignmentDueDate assignmentKey={calendarData.assignments.statisticsLabAvailable} />.
...
Due:
<AssignmentDueDateTime assignmentKey={calendarData.assignments.statisticsLab} />.
