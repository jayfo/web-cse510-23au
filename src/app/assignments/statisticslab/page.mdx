...
[http://depts.washington.edu/acelab/proj/ps4hci/index.html](http://depts.washington.edu/acelab/proj/ps4hci/index.html)
...
If you talked through the analysis with others who were not your partner, also indicate this in your submission.
...
For example, it will be your responsibility to decide what type to assign each field
(e.g., continuous, ordinal, nominal, fixed effect, random effect).
...
For example, analyses in the papers associated with assignment data were performed before many forms of analysis were available in commonly-used tools.
...
The statistics lab will be made available by <AssignmentDueDate assignmentKey={calendarData.assignments.statisticsLabAvailable} />.

{/*
The statistics lab is available for download:

<CourseDataLink outerComponent="p" linkKey={courseData.linkStatisticsLab} />
*/}

## Submission

Due: <AssignmentDueDateTime assignmentKey={calendarData.assignments.statisticsLab} />.

Submit both your notebook in RMD format and a rendering in PDF format:

<AssignmentSubmitCanvasLink outerComponent="p" assignmentKey={calendarData.assignments.statisticsLab} />
