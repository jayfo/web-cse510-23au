...
<TBD>{"<CourseInformationLink linkName='linkProjectProposalIdeas' />"}</TBD>

### Project Deliverables

Project deliverables are defined in terms of a proposal, a pair of self-defined milestone reports, and a final report.

Proposal Due: <AssignmentDueDate assignmentKey={calendarData.assignments.projectProposal} />.

Milestone Report 1 Due: <AssignmentDueDate assignmentKey={calendarData.assignments.projectMilestoneReport1} />.

Milestone Report 2 Due: <AssignmentDueDate assignmentKey={calendarData.assignments.projectMilestoneReport2} />.

Final Report Due: <AssignmentDueDate assignmentKey={calendarData.assignments.projectFinalReport} />.
...
<TBD>{"<CourseInformationLink linkName='linkProjectProposalSamples' />"}</TBD>
...
Due: <AssignmentDueDate assignmentKey={calendarData.assignments.projectProposal} />.
...
Due: <AssignmentDueDate assignmentKey={calendarData.assignments.projectFinalReport} />.
