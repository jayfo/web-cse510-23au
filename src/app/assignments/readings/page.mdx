...
The [Calendar](/calendar) will link to assigned readings and provide any day-specific revisions to this reading structure.
...
we also assign Reading Reports that are implemented as a pre-class forum discussion.
...
<CourseLink outerComponent="p" linkKey="linkCanvasDiscussion" />
...
Students will self-organize into small groups of 4 to 5 students to discuss the readings
