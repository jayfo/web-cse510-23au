...
import CourseDataLink from "@/components/CourseDataLink";
...
<Box display="flex" flexDirection="row" alignItems="flex-start">
  <Box marginTop={-2} marginBottom={-2} marginRight={2}>
    <p>James Fogarty</p>
    <p>
      <Image src={imgPhotoJames} height="150" alt="Photo of James Fogarty." />
    </p>
  </Box>
  <Box marginTop={-2} marginBottom={-2} marginRight={2}>
    <p>Shaan Chopra</p>
    <p>
      <Image src={imgPhotoShaan} height="150" alt="Photo of Shaan Chopra." />
    </p>
  </Box>
</Box>
...
- Class Time & Location
  ...
  <TBD outerComponent="p">Location TBD.</TBD>
  {/* [CSE2](https://www.washington.edu/maps/#!/cse2) Room [G04](https://www.washington.edu/classroom/CSE2+G04) */}

Class may be conducted via Zoom when indicated in the [Calendar](/calendar),
and we may support participation via Zoom as an accommodation (e.g., due to illness).
If so, we will use meeting information provided by email and in
<CourseDataLink linkKey="linkCanvas">Canvas</CourseDataLink>.
...
- Canvas
  ...
  <CourseDataLink outerComponent="p" linkKey="linkCanvas" />
...
- 20%: Reading Reports and In-Class Small Group Discussion
  ...
  Based on the [In-Class Discussion Format](/assignments/readings#in-class-discussion-format),
...
<CourseDataLink outerComponent="p" linkKey='linkUniversitySyllabusGuidelines' />
...
<CourseDataLink outerComponent="p" linkKey='linkGitHub' />
